...
UINavigationControllerDelegate{
    ...
    // Allow to share a Meme by creating a composited image
    ...
    // To accommodate switching between multiple views, reset functionality of text fields and image 
    // is removed compared to Meme 1.0 submission
    @IBAction func didPressCancel(sender: UIBarButtonItem) {
        // Dismiss the current view and show the past view when Cancel is pressed
